...
axios.defaults.baseURL =
  "https://europe-west2-burunduk-fb67a.cloudfunctions.net/api";
      ...
      <Provider store={store}>
        <Router>
          <PersistGate persistor={persistor}>
            <Container fluid className="navigation" id="navigation-menu-width">
              <Navbar />
            </Container>
            <Container fluid>
              <Switch>
                ...
                <Route
                  exact
                  path="/auctions/:app/:auctionId/:type"
                  component={auction}
                />
                {/* User Ranking */}
