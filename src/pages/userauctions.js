...
import { loadUserAllSearch, loadUserAllOffer } from '../redux/actions/Auctions'
...
export default connect(mapStateToProps, { loadUserAllSearch, loadUserAllOffer })(userauctions)
